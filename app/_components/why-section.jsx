...
export default function WhySection() {
  ...
  return (
    <section id="why-section" className="py-20 bg-background max-w-7xl mx-auto px-4 ">
      <div className="container px-4 md:px-6 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {challenges.map((challenge, index) => (
            <div
              key={index}
              className="text-center p-6 rounded-lg border border-border bg-card hover:shadow-lg transition-shadow duration-200"
            >
              <div className="inline-flex items-center justify-center w-12 h-12 bg-destructive/10 dark:bg-destructive/20 rounded-lg mb-4">
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center space-x-2 bg-destructive/10 dark:bg-destructive/20 text-destructive px-4 py-2 rounded-full">
